...
T = delaunayn(P,{'QJ'}); %% QJ pertubes the point to general position - there is some problem with some of the points being cospherical or cocircular - More Investigation Required
n = size(T,1);
W = zeros(n,1);
C=0;
for m = 1:n
